...
<svg xmlns='http://www.w3.org/2000/svg' width='800' height='450' viewBox='0 0 800 450'>
  ...
  <!-- Title -->
  <text x='400' y='130' font-family='Segoe UI, Arial, sans-serif' font-size='40' font-weight='bold' text-anchor='middle' fill='#87CEEB'>
    LiaScript Training Sequence
  </text>
  
  <!-- Subtitle -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='30' font-weight='bold' text-anchor='middle' fill='#1A73E8'>
    Zero to Hero in 30 Minutes 🚀
  </text>
  
  <!-- Footer -->
  <text x='400' y='320' font-family='Segoe UI, Arial, sans-serif' font-size='20' text-anchor='middle' fill='gray'>
    A fast-paced hands-on course to master LiaScript basics
  </text>
</svg>
...
<svg xmlns='http://www.w3.org/2000/svg' width='800' height='450' viewBox='0 0 800 450'>
  ...
  <!-- Subtitle -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='35' font-weight='bold' text-anchor='middle' fill='#1A73E8'>
     Introduction & First Steps (5 minutes)
  </text>
...
<svg xmlns='http://www.w3.org/2000/svg' width='800' height='450' viewBox='0 0 800 450'>
  ...
  <!-- Subtitle -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='30' font-weight='bold' text-anchor='middle' fill='#1A73E8'>
     Adding Interactive Elements (7 minutes)
  </text>
...
__Task: Transform static content into interactive quizzes__
...
<svg xmlns='http://www.w3.org/2000/svg' width='800' height='450' viewBox='0 0 800 450'>
  <!-- Background -->
  <rect width='800' height='450' fill='#001F4D' />
  
  <!-- Dark blue rounded rectangle container -->
  <rect x='50' y='50' width='700' height='350' rx='20' fill='#0A1F44' />
  
  <!-- Title (empty, add text if needed) -->
  <text x='400' y='130' font-family='Segoe UI, Arial, sans-serif' font-size='50' font-weight='bold' text-anchor='middle' fill='#3B82F6'>
  </text>
  
  <!-- Subtitle -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='30' font-weight='bold' text-anchor='middle' fill='#60A5FA'>
    Multimedia Integration (5 minutes)
  </text>
  
  <!-- Footer (empty, add text if needed) -->
  <text x='400' y='320' font-family='Segoe UI, Arial, sans-serif' font-size='22' text-anchor='middle' fill='#A0AEC0'>
  </text>
</svg>
...
__Task: Embed videos, audio, and images__
...
<svg xmlns='http://www.w3.org/2000/svg' width='800' height='450' viewBox='0 0 800 450'>
  ...
  <rect x='50' y='50' width='700' height='350' rx='20' fill='#0059b3' />
  
  <!-- Title (empty, add if needed) -->
  <text x='400' y='130' font-family='Segoe UI, Arial, sans-serif' font-size='50' font-weight='bold' text-anchor='middle' fill='#99ccff'>
  </text>
  
  <!-- Subtitle -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='30' font-weight='bold' text-anchor='middle' fill='#cce6ff'>
    Code Execution & Programming (6 minutes)
  </text>
  
  <!-- Footer (empty, add if needed) -->
  <text x='400' y='320' font-family='Segoe UI, Arial, sans-serif' font-size='22' text-anchor='middle' fill='#99ccff'>
  </text>
</svg>
...
__Advanced: Add code execution for your subject (Python, JavaScript, HTML, etc.)__
...
<svg xmlns='http://www.w3.org/2000/svg' width='800' height='450' viewBox='0 0 800 450'>
  ...
  <!-- Subtitle -->
  <text x='400' y='200' font-family='Segoe UI, Arial, sans-serif' font-size='30' font-weight='bold' text-anchor='middle' fill='#1A73E8'>
     Course Structure & Navigation (2 minutes)
  </text>
...
<div style="background: linear-gradient(135deg, #4A90E2, #50E3C2); border-radius: 16px; padding: 1.8em; color: white; font-family: Arial, sans-serif; line-height: 1.6; box-shadow: 0 4px 15px rgba(0,0,0,0.2); max-width: 600px;">
...
2. Explore: Visit [LiaScript Course Examples](https://liascript.github.io/course/) for advanced examples  
...
<div style="background: linear-gradient(135deg, #FF7E5F, #FEB47B); border-radius: 16px; padding: 1.8em; color: #4A2C00; font-family: Arial, sans-serif; line-height: 1.6; box-shadow: 0 4px 15px rgba(0,0,0,0.2); max-width: 600px;">

### ⚡ Tips for Effective Course Creation
...
<div style="background: linear-gradient(135deg, #B3D4FC, #E6F0FF); border-radius: 16px; padding: 1.8em; color: #003366; font-family: Arial, sans-serif; line-height: 1.6; box-shadow: 0 4px 15px rgba(0,0,0,0.1); max-width: 600px;">

### 🎯 Goal

Before leaving today, create a 3-slide interactive mini-course on any topic you teach.
...
<div style="background: linear-gradient(135deg, #001F4D, #003366); border-radius: 16px; padding: 1.8em; color: white; font-family: Arial, sans-serif; line-height: 1.6; box-shadow: 0 4px 15px rgba(0,0,0,0.3); max-width: 600px;">

### 📚 Useful Links

- Official Documentation: [https://liascript.github.io/](https://liascript.github.io/)  
- Course Examples: [https://github.com/liaScript/docs](https://github.com/liaScript/docs)  
- Template Repository: [https://github.com/liaScript/template](https://github.com/liaScript/template)  
...
# END
<div style="background: linear-gradient(135deg, #001F4D, #003366); border-radius: 20px; padding: 3em; color: white; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; text-align: center; box-shadow: 0 6px 20px rgba(0,0,0,0.4); max-width: 800px; margin: 2em auto;">

<h1 style="font-size: 3em; margin-bottom: 0.3em;">Thank You!</h1>
<p style="font-size: 1.5em; margin-top: 0;">For your time and participation.</p>
